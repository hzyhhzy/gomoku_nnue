...
#8 trunkconv2 trunklr2p trunklr2v
    ...
    print('', file=exportfile)
    print("trunklr2p_w", file=exportfile)
    for i in range(groupc):
        print(int(trunklr2p_w[i] * 2 ** 15), end=' ', file=exportfile)
    print('', file=exportfile)
    print("trunklr2p_b", file=exportfile)
    for i in range(groupc):
        print(int(trunklr2p_b[i]), end=' ', file=exportfile)
    print('', file=exportfile)
    print("trunklr2v_w", file=exportfile)
    for i in range(groupc):
        print(int(trunklr2v_w[i] * 2 ** 15), end=' ', file=exportfile)
    print('', file=exportfile)
    print("trunklr2v_b", file=exportfile)
    for i in range(groupc):
        print(int(trunklr2v_b[i]), end=' ', file=exportfile)
    print('', file=exportfile)
...
#9 policy_linear
    ...
    # write
    print("policy_linear_w", file=exportfile)
    for i in range(groupc):
        print(int(policy_linear_w[i] * 2 ** 15), end=' ', file=exportfile)
    print('', file=exportfile)
    print("scale_policyInv", file=exportfile)
    print(1/scale_policy, end=' ', file=exportfile)
    print('', file=exportfile)
